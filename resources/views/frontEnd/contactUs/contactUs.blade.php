				...
				<div class="col-xs-6 col-sm-6 contact-w3lsleft">
					<div class="contact-grid agileits">
						<h4>DROP US A LINE </h4>
                                                ...
                                                {!!Form::open(['method'=>'POST', 'url'=>'/cusMessage'])!!}
                               {{ Form::text('CusName', null, ['class' => 'form-control', 'placeholder'=>'you Name','required'=>'required']) }}
				{{ Form::email('email', null, ['class' => 'form-control', 'placeholder'=>'you email','required'=>'required']) }}
				{{ Form::text('phoneNumber', null, ['class' => 'form-control', 'placeholder'=>'Phone Number','required'=>'required']) }}
				
 				{{ Form::textarea ('mail', null, ['class' => 'form-control', 'placeholder'=>'Message','required'=>'required']) }}
